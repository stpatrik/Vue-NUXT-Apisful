    ...
    >
      <div v-show="status === statuses.success" class="cart-message">
        ...
        <div class="cart-message__title">
          Ваш заказ был размещен. Мы свяжемся с вами в ближайшее время.
        </div>
      </div>
      <div v-show="status === statuses.fail" class="cart-message">
        ...
        <div class="cart-message__title">
          Что-то пошло не так. Попробуйте оформить заказ еще раз или свяжитесь с нами по электронной почте.
        </div>
      </div>
