...
async function createApp(ssrContext, config = {}) {
  ...
  const app = {
    head: {"title":"Kluber Shop","meta":[{"charset":"utf-8"},{"name":"viewport","content":"width=device-width, initial-scale=1"},{"hid":"description","name":"description","content":"![nuxt.js + apisful](static\u002Frepo-hero-image.png)"}],"link":[{"rel":"icon","type":"image\u002Fx-icon","href":"\u002Ffavicon.ico"}],"style":[],"script":[]},
